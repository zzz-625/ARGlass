...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(((1UL<<31)|(1<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0xF<<10) |( 4<<5)|(27) ), 0, (((2-1)<< (4)) & (0xful << (4))));
     
    CLK_EnableModuleClock(((1UL<<31)|(1<<29)|(0x0<<25)|( 0<<20)|(0<<18)|(0xF<<10) |( 4<<5)|(27) ));
...
void GPIO_Init(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000010), 0x2UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000020), 0x2UL);
	
	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000400), 0x2UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000800), 0x2UL);
	
	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)), (0x00000400), 0x2UL);
	
	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000040), 0x1UL);
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((6)<<2)))) = 1;
    
	 
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04000)), (0x00000200), 0x1UL);
}
...
void WDT_IRQHandler(void)
{
    ...
    if((((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->ISR & (0x1ul << (0)) ? 1 : 0))
    {
        
        (((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->ISR = (0x1ul << (0)));
        printf("Reset WDT counter\n");
		(((WDT_T *) (((uint32_t)0x40000000) + 0x04000))->CTL |= (0x1ul << (0)));
	}
	SYS_LockReg();
}
...
int main(void)
{
	...
	SPI_Open(((SPI_T *) (((uint32_t)0x40000000) + 0xD0000)), (0x0), ((0x1ul << (11)) | (0x1ul << (2))), 8, 800000);

    ( (((SPI_T *) (((uint32_t)0x40000000) + 0xD0000)))->CTL |= (0x1ul << (10)) );
