#line 1 "..\\Library\\fih\\src\\Ecx335af_calibration.c"
...
#line 2 "..\\Library\\fih\\src\\Ecx335af_calibration.c"
...
#line 3 "..\\Library\\fih\\src\\Ecx335af_calibration.c"
...
#line 4 "..\\Library\\fih\\src\\Ecx335af_calibration.c"
...
#line 5 "..\\Library\\fih\\src\\Ecx335af_calibration.c"
...
void Set_Vcali_To_Data_Flash(void)
{
	...
	uint32_t    u32Addr;
	for (u32Addr = 0xFC00; u32Addr < 0xFDFF; u32Addr += 0x200)
    {
	...
	data_flash.cali_flag = FMC_Read(0xFC00);
	
	if (1 !=data_flash.cali_flag)
	{
		data_flash.cali_flag = 1;
		FMC_Write(0xFC00, data_flash.cali_flag);
	}
	
	FMC_Write(0xFC00 + 4, data_flash.h1);
	FMC_Write(0xFC00 + 8, data_flash.v1);
	FMC_Write(0xFC00 + 12, data_flash.h2);
	FMC_Write(0xFC00 + 16, data_flash.v2);
...
void Get_Vcali_From_Data_Flash(void)
{
	...
	if (1 == data_flash.cali_flag)
	{
		data_flash.h1 = FMC_Read(0xFC00+4);
		data_flash.v1 = FMC_Read(0xFC00+8);
		data_flash.h2 = FMC_Read(0xFC00+12);
		data_flash.v2 = FMC_Read(0xFC00+16);
	}
	else
	{
		data_flash.h1 = 0;
