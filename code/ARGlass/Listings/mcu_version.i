#line 1 "..\\Library\\fih\\src\\mcu_version.c"
...
#line 2 "..\\Library\\fih\\src\\mcu_version.c"
...
#line 3 "..\\Library\\fih\\src\\mcu_version.c"
...
#line 4 "..\\Library\\fih\\src\\mcu_version.c"
...
#line 5 "..\\Library\\fih\\src\\mcu_version.c"
...
void Data_Flash_Value_Init(void)
{
	...
	data_flash.mcu_version = "V20.00.07";
	data_flash.lt7211b_fwversion = "V10.00.02";
...
void MCU_FMC_Init(void)
{
    ...
    FMC_Open();
	if (set_data_flash_base(0xFC00) < 0)
    {
        printf("Failed to set Data Flash base address!\n");
        goto lexit;
    }
			
	for (u32Addr = 0xFC00; u32Addr < 0xFFFF; u32Addr += 0x200)
	{
...
void Set_Mcu_Version(void)
{
    ...
    FMC_Open();
	uint32_t    u32Addr;
	for (u32Addr = 0xFE00; u32Addr < 0xFFFF; u32Addr += 0x200)
	{
	...
	data_flash.mcu_version_flag = FMC_Read(0xFE00);
	
	if (1 !=data_flash.mcu_version_flag)
	{
		data_flash.mcu_version_flag = 1;
		FMC_Write(0xFE00, data_flash.mcu_version_flag);
	}
	
	FMC_Write(0xFE00 + 4, data_flash.mcu_version);
	FMC_Write(0xFE00 + 14, data_flash.lt7211b_fwversion);
	FMC_Write(0xFE00 + 24, data_flash.dl_flags);
...
void Get_Mcu_Version(void)
{
	...
	if (1 == data_flash.mcu_version_flag)
	{
		data_flash.mcu_version = FMC_Read(0xFE00+4);
		data_flash.lt7211b_fwversion = FMC_Read(0xFE00+14);
	}
	else
	{
		data_flash.mcu_version = 0;
		data_flash.lt7211b_fwversion = 0;
	}
	
	dl_flag = FMC_Read(0xFE00 + 24);
