#line 1 "..\\Library\\fih\\src\\lt_i2c.c"
...
#line 2 "..\\Library\\fih\\src\\lt_i2c.c"
...
#line 3 "..\\Library\\fih\\src\\lt_i2c.c"
...
#line 4 "..\\Library\\fih\\src\\lt_i2c.c"
...
{
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((5)<<2)))) = 1;;
...
static void iic_sendbyte(uint8_t byte)
{
	...
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((5)<<2)))) = 1;;
	iic_delay();
	if(((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((4)<<2)))) != 0))
	{
		ack = RESET;
	}
	else
...
{
	return iic_write_byte(0x56, RegAddr, &Data, 1);	
}

int LT_WriteI2C_ByteN(uint8_t RegAddr, uint8_t *P_Data, uint16_t N)
{
	return iic_write_byte(0x56, RegAddr, P_Data, N);	
}		
...
{
	uint8_t p_data=0;
	if(iic_read_byte(0x56, RegAddr, &p_data, 1) != 1 )
	{
			return 0;
	}
	return p_data;
...
{
	if( iic_read_byte(0x56, RegAddr, p_data, N) != 1)
	{
		return 0;
	}
	return 1;
