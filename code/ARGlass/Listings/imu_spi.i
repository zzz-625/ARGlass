#line 1 "..\\Library\\fih\\src\\imu_spi.c"
...
#line 2 "..\\Library\\fih\\src\\imu_spi.c"
...
#line 3 "..\\Library\\fih\\src\\imu_spi.c"
...
#line 4 "..\\Library\\fih\\src\\imu_spi.c"

static bmm050_t *p_bmm050;

void Spi_WriteReg_Gyro(uint8_t reg, uint8_t u8Value)
{
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((9)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((11)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 0;
    
    
	( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->TX0 = (reg << 8) | u8Value );
	( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->CTL |= (0x1ul << (0)) );
    while(( ((((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0));

    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 1;
}
void Spi_WriteReg_Acc(uint8_t reg, uint8_t u8Value)
{
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((11)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((9)<<2)))) = 0;
...
void Spi_WriteReg_Mag(uint8_t reg, uint8_t u8Value)
{
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((9)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((11)<<2)))) = 0;
...
uint8_t Spi_ReadReg_Gyro(uint8_t reg)
{
    ...
    ( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->TX0 = (reg | 0x80) << 8 | 0x00 );
	( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->CTL |= (0x1ul << (0)) );
    while(( ((((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->CTL & (0x1ul << (0))) == (0x1ul << (0)) ? 1:0));
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 1;

	ReturnValue = (( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->RX0 ) & 0xff);
...
{
	SYS_UnlockReg();
	CLK_SetModuleClock(((1UL<<31)|(2<<29)|(1<<25) |(21<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(13) ), (0x0UL<<(21)), 1);
	CLK_EnableModuleClock(((1UL<<31)|(2<<29)|(1<<25) |(21<<20)|(0<<18)|(0x0<<10)|( 0<<5)|(13) ));
	((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP &= ~((0x7ul << (4)) | (0x7ul << (8)) | (0x7ul << (12)));
	((SYS_T *) (((uint32_t)0x50000000) + 0x00000))->PC_H_MFP = ((1UL<<(4)) | (1UL<<(8)) | (1UL<<(12)));	
	SYS_LockReg();
	
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04080)), (0x00000100), 0x1UL);
	GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)), (0x00000800), 0x1UL);
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)), (0x00000200), 0x1UL);
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(2))) + ((8)<<2)))) = 1;
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((11)<<2)))) = 1;
    (*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(1))) + ((9)<<2)))) = 1;
	
	SPI_Open(((SPI_T *) (((uint32_t)0x40100000) + 0x30000)), (0x0), ((0x1ul << (11)) | (0x1ul << (2))), 16, 400000);
	
	( (((SPI_T *) (((uint32_t)0x40100000) + 0x30000)))->CTL &= ~(0x1ul << (10)) );
...
void bmm050_get_data_rate(uint8_t *v_data_rate_u8)
{
	...
	int8_t com_rslt = ((int8_t)-1);
	uint8_t v_data_u8 = 0;

	com_rslt = Spi_ReadReg_Mag(0x4C);
	*v_data_rate_u8 = ((v_data_u8 & (0x38)) >> (3));
...
void bmm050_set_data_rate(uint8_t v_data_rate_u8)
{
	...
	v_data_u8 = ((v_data_u8 & ~(0x38)) | ((v_data_rate_u8<<(3))&(0x38)));
			
	Spi_WriteReg_Mag(((0x4C)),v_data_u8);
}
...
void bmm050_set_rep_XY(uint8_t v_rep_xy_u8)
{
	...
	uint8_t v_data_u8 = 0;
		...
		Spi_WriteReg_Mag((0x51),v_data_u8);
...
void bmm050_set_rep_Z(uint8_t v_rep_z_u8)
{
	...
	uint8_t v_data_u8 = 0;
		...
		Spi_WriteReg_Mag((0x52),v_data_u8);
...
void bmm050_get_power_mode(uint8_t *v_power_mode_u8)
{
	...
	uint8_t v_data_u8 = 0;
		...
		if (!com_rslt) {
			*v_power_mode_u8 = ((v_data_u8 & (0x01)) >> (0));
		}
}
...
void bmm050_set_power_mode(uint8_t v_power_mode_u8)
{
	...
	uint8_t v_data_u8 = 0;
		...
		v_data_u8 = ((v_data_u8 & ~(0x01)) | ((v_power_mode_u8<<(0))&(0x01)));
...
int8_t bmm050_set_functional_state(uint8_t v_functional_state_u8)
{
	...
	uint8_t v_data_u8 = 0;
		...
		case (0x00):
			...
			v_data_u8 = Spi_ReadReg_Mag(((0x4C)));
			v_data_u8 = ((v_data_u8 & ~(0x06)) | (((0x00)<<(1))&(0x06)));
...
int8_t bmm050_init_trim_registers(void)
{
	...
	uint8_t v_data_u8[(2)] = {0, 0};
	
	p_bmm050->dig_x1 = Spi_ReadReg_Mag((0x5D));
	
	p_bmm050->dig_y1 = Spi_ReadReg_Mag((0x5E));
	
	p_bmm050->dig_x2 = Spi_ReadReg_Mag((0x64));
	
	p_bmm050->dig_y2 = Spi_ReadReg_Mag((0x65));
	
	p_bmm050->dig_xy1 = Spi_ReadReg_Mag((0x71));
	
	p_bmm050->dig_xy2 = Spi_ReadReg_Mag((0x70));
	
	

 
	
	v_data_u8[0] = Spi_ReadReg_Mag((0x6A));
	v_data_u8[1] = Spi_ReadReg_Mag((0x6B));
	p_bmm050->dig_z1 = (uint16_t)((((uint32_t)((uint8_t)v_data_u8[1])) << 8) | v_data_u8[0]);


	v_data_u8[0] = Spi_ReadReg_Mag((0x68));
	v_data_u8[1] = Spi_ReadReg_Mag((0x69));
	p_bmm050->dig_z2 = (int16_t)((((int32_t)((int8_t)v_data_u8[1])) << 8) | v_data_u8[0]);

	v_data_u8[0] = Spi_ReadReg_Mag((0x6E));
	v_data_u8[1] = Spi_ReadReg_Mag((0x6F));
	p_bmm050->dig_z3 = (int16_t)((((int32_t)((int8_t)v_data_u8[1])) << 8) | v_data_u8[0]);
	

	v_data_u8[0] = Spi_ReadReg_Mag((0x62));
	v_data_u8[1] = Spi_ReadReg_Mag((0x63));
	p_bmm050->dig_z4 = (int16_t)((((int32_t)((int8_t)v_data_u8[1])) << 8) | v_data_u8[0]);
	
	v_data_u8[0] = Spi_ReadReg_Mag((0x6C));
	v_data_u8[1] = Spi_ReadReg_Mag((0x6D));
	
	v_data_u8[(1)] = ((v_data_u8[(1)] & (0x7F)) >> (0));
...
int8_t bmm050_set_presetmode(uint8_t v_presetmode_u8)
{
	...
	case (3):
		...
		bmm050_set_data_rate(((5)));
		 
		bmm050_set_rep_XY((23));
...
float bmm050_compensate_X_float(int16_t mag_data_x, uint16_t data_r)
{
	...
	if (mag_data_x != -4096	 )
	{
		if ((data_r != 0) && (p_bmm050->dig_xyz1 != 0))
		{
...
float bmm050_compensate_Z_float (int16_t mag_data_z, uint16_t data_r)
{
	...
	if (mag_data_z != -16384)
	{
		if ((p_bmm050->dig_z2 != 0) && (p_bmm050->dig_z1 != 0) && (p_bmm050->dig_xyz1 != 0) && (data_r != 0))
		{
...
void bmm050_init(bmm050_t *bmm050)
{
	...
	com_rslt += bmm050_set_presetmode((2));
}
...
void init_imu_chip(bmm050_t *bmm050)
{
	...
	uint8_t v_data_rate_u8 = 0;

	int32_t com_rslt = ((int8_t)-1);
	...
	com_rslt = bmm050_set_functional_state((0x00));
...
void Imu_Acc_Raw(bma2x2_acc_data *accel)
{
	uint8_t i = 0;
	uint8_t acc[10];
#line 572 "..\\Library\\fih\\src\\imu_spi.c"
