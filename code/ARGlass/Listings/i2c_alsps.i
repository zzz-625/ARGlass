#line 1 "..\\Library\\fih\\src\\i2c_alsps.c"
...
#line 3 "..\\Library\\fih\\src\\i2c_alsps.c"
#line 4 "..\\Library\\fih\\src\\i2c_alsps.c"
#line 5 "..\\Library\\fih\\src\\i2c_alsps.c"
#line 6 "..\\Library\\fih\\src\\i2c_alsps.c"
...
{
	return LP_WriteI2C_Byte((0x1E<<1),RegAddr,Data);
}

uint8_t ALP_ReadI2C_Byte(uint8_t RegAddr)
{
	 return LP_ReadI2C_Byte((0x1E<<1), RegAddr);
}

void sy3096ps_set_threshold(uint8_t ht, uint8_t lt)
{
    ALP_WriteI2C_Byte(0x04, ht);
    ALP_WriteI2C_Byte(0x03, lt);
}
...
void i2c_alsps_init()
{
	ALP_WriteI2C_Byte(0x22,0x00);
	
	ALP_WriteI2C_Byte(0x02,0x80|0x10|0x00|0x05);
	
	if(0x80 == 0x00)
	{
		sy3096ps_set_threshold(100, 0);
	}
	else if (0x80 == 0x80)
	{
		sy3096ps_set_threshold(100, 50);
	}
...
void PS_Interrupt_Init(void)
{
    ...
    GPIO_SetMode(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)), (0x00001000), 0x0UL);
    
    GPIO_EnableInt(((GPIO_T *) (((uint32_t)0x50000000) + 0x04040)), 12, 0x00010001UL);
...
void sy3096ps_enable(int enable)
{
	if(1 == enable)
	{
       ...
       sy3096ps_set_threshold(100, 50);
		...
		ALP_WriteI2C_Byte(0x01, 0x40);
	}
	else
        ALP_WriteI2C_Byte(0x01, 0x00);
}
