#line 1 "..\\Library\\fih\\src\\lp_i2c.c"
...
#line 2 "..\\Library\\fih\\src\\lp_i2c.c"
...
#line 3 "..\\Library\\fih\\src\\lp_i2c.c"
...
#line 4 "..\\Library\\fih\\src\\lp_i2c.c"
...
#line 5 "..\\Library\\fih\\src\\lp_i2c.c"
...
{
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((11)<<2)))) = 1;;
	 
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((10)<<2)))) = 1;;
	iic_delay();
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((10)<<2)))) = 0;;
	iic_delay();
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((11)<<2)))) = 0;; 
	iic_delay();
}	
...
static void iic_sendbyte(uint8_t byte)
{
	...
	(*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((11)<<2)))) = 1;;
	iic_delay();
	if(((*((volatile uint32_t *)(((((uint32_t)0x50000000) + 0x04200)+(0x40*(0))) + ((10)<<2)))) != 0))
	{
		ack = RESET;
	}
	else
