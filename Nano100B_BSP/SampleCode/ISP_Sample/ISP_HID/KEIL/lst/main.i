...
void SYS_Init(void)
{
    ...
    ((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->PLLCTL = 0x20220;
	
	     
    while ((!(((CLK_T *) (((uint32_t)0x50000000) + 0x00200))->CLKSTATUS & ((0x1ul << (4)) | (0x1ul << (2))))));
...
int32_t main(void)
{
	...
	FMC_Read_User(0xFE00 + 24,&Download_Flags);
