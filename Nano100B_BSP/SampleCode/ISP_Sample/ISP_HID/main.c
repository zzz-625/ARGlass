...
void SYS_Init(void)
{
    ...
    while ((!(CLK->CLKSTATUS & (CLK_CLKSTATUS_HIRC_STB_Msk | CLK_CLKSTATUS_PLL_STB_Msk))));
...
int32_t main(void)
{
	...
	FMC_Read_User(DATA_FLASH_VER_BASE + 24,&Download_Flags);
